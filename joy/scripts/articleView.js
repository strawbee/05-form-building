...
// COMMENT: Where is this function called? Why?
// This function is called in the index.html page, at the bottom right before the </body> tag. We are placing the script directly into the .html page because the index.html and new.html pages use the same .js files, and the only difference is that they call different init functions. It's placed below the other .js files so that it can call the function from those files.
